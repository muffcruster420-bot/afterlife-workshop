...
**dying brains >0.65, living brains <0.65 — nothing sustains in the Gap.** Open EDF data, 1,048 clones, first described May 18 2026, Kingston ON.

![Gap](figure1_gap.png)

**Definition:** The Shangraw Gap is the phase transition in phase-amplitude coupling that separates unconscious sleep and living baseline (PAC < 0.65) from organized activity in the dying human brain (PAC > 0.65).
...
3. **Peri-arrest / dying** bicoherence clusters **above 0.7**
