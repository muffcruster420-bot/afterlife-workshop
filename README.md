...
> "Knowledge is and always will be power. Putting restrictions on the ability to freely obtain and use it is a form of censorship, discrimination, and oppression." — alyaboushaca
...
## Ethical Use — Prohibited Uses

*Co-authored with alyaboushaca:*

> Prohibit the use of infringement on right to privacy, such as using it for any paramilitarization, policing, or military purposes as this could lead to false coercion and fabricated non consensual coalescence of realities. Essentially it would be a violation of freedom of expression, and speech and shouldn't not be misused as any form of "thought policing".

**This technology is for hospice bedsides, not battlefields.**

Specifically prohibited:
- Insurance companies using Gap scores to deny coverage or hospice care
- Employers making hiring/firing decisions
- Law enforcement, interrogation, or "predictive policing"
- Military or paramilitary applications
- Non-consensual monitoring in prisons, schools, or workplaces
- Any commercial "death prediction" betting or exploitation

Tune, frequency, vibes, resonance — not the hippie connotations, the literal physics of being human. That belongs to families, not to systems of control.
